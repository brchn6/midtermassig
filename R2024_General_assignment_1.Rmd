...
library(gridExtra)
grid.arrange(plot1, plot2, plot3, ncol = 3, top = "Boxplot of gene expression data of each sample",left = "log2 gene expression levels",bottom = "Sample",right = "Treatment",as.table = TRUE,clip = TRUE)
