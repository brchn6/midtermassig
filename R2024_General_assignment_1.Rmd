...
t.test(log2.norm[,grep("DC", names(log2.norm))], mu = 0, alternative = "two.sided")
...
print(p1)
ANSWER6 = "The number of genes that are upregulated in t6 is:  `r sum(log2.norm$upregulated == 'upregulated')`(55)"
```
