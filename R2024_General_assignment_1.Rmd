...
df <- df[,c("id","DC.0hr.r1","DC.0hr.r2","DC.0hr.r3","DC.3hr.r1","DC.3hr.r2","DC.3hr.r3","DC.6hr.r1","DC.6hr.r2","DC.6hr.r3","variance","geneSymbol","name","desc","txLength")]
df <- df %>% 
...
scaledData <- cbind(df[,c("geneSymbol")],scaledData)
scaledData[df[, c("geneSymbol")]] <- df[, c("geneSymbol")]
...
scaledData <- scaledData[1:50,]
functio_for_ggplot_boxplot(scaledData,"Boxplot of the scaled expression of the first 50 genes") %>% print()
```
